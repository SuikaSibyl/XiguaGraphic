...
struct CuVertex : public Vector3Df
{
	...
	CuVertex(float x, float y, float z, float nx, float ny, float nz, float amb = 60.f)
		:
	...
	CuVertex()
		:
		Vector3Df(0, 0, 0), _normal(Vector3Df(0, 0, 0)), _ambientOcclusionCoeff(0)
	{
		// assert |nx,ny,nz| = 1
	}
};
